...
lazy_static::lazy_static! {
 ...
 pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Ljz739328".to_string());
        RwLock::new(map)
 };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["trust.dynv6.net"];
pub const RS_PUB_KEY: &str = "vISGSbRFdXfj3TlcFDr7KPIjqGFbiAa3ubh0kEVfO9s=";
